  ...
  {divArray.map(({ id, heading, image, link }) => (
    ...
    >
      ...
      <img
        ...
        alt={heading}
        loading="lazy"
        className="absolute h-36 w-36 object-contain opacity-100 group-hover:transition duration-300 ease-in-out"
        style={{
            top: '50%',
            left: '50%',
    ...
    />
      ...
      <div className="flex justify-between items-center absolute bottom-0 left-0 right-0 bg-zinc-800 bg-opacity-50 p-2">
        ...
        <a
          href={link}
          className="text-lg text-blue-500 hover:underline hover:text-blue-300"
        >
          Source code
        </a>
      </div>
